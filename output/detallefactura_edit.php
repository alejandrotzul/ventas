...
$page_layouts["detallefactura_edit"] = $layout;
...
$page_layouts["detallefactura_list"] = $layout;
...
$keys = array();
$keys["ventas_idventas"] = postvalue("editid1");
$keys["facturas_numeroFactura"] = postvalue("editid2");
