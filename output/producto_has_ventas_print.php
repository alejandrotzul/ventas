...
require_once("include/producto_has_ventas_variables.php");
...
$page_layouts["producto_has_ventas_print"] = $layout;
...
$page_layouts["producto_masterprint"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["ventas_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "producto_has_ventas" );
