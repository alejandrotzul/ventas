...
class tDAL
{
	var $tblmydb_at_localhost__cliente;
	var $tblmydb_at_localhost__detallefactura;
	var $tblmydb_at_localhost__facturas;
	var $tblmydb_at_localhost__producto;
	var $tblmydb_at_localhost__producto_has_ventas;
	var $tblmydb_at_localhost__ventas;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "cliente", "varname" => "mydb_at_localhost__cliente", "altvarname" => "cliente", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "detallefactura", "varname" => "mydb_at_localhost__detallefactura", "altvarname" => "detallefactura", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "facturas", "varname" => "mydb_at_localhost__facturas", "altvarname" => "facturas", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "producto", "varname" => "mydb_at_localhost__producto", "altvarname" => "producto", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "producto_has_ventas", "varname" => "mydb_at_localhost__producto_has_ventas", "altvarname" => "producto_has_ventas", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
		$this->lstTables[] = array("name" => "ventas", "varname" => "mydb_at_localhost__ventas", "altvarname" => "ventas", "connId" => "mydb_at_localhost", "schema" => "", "connName" => "mydb at localhost");
	}
