...
function fillProjectEntites()
{
	...
	$projectEntities[ "detallefactura" ] = array( "url" => "detallefactura", "type" => 0 );
	$projectEntitiesReverse[ "detallefactura" ] = "detallefactura";
	$projectEntities[ "facturas" ] = array( "url" => "facturas", "type" => 0 );
	$projectEntitiesReverse[ "facturas" ] = "facturas";
	$projectEntities[ "producto" ] = array( "url" => "producto", "type" => 0 );
	$projectEntitiesReverse[ "producto" ] = "producto";
	$projectEntities[ "producto_has_ventas" ] = array( "url" => "producto_has_ventas", "type" => 0 );
	$projectEntitiesReverse[ "producto_has_ventas" ] = "producto_has_ventas";
	$projectEntities[ "ventas" ] = array( "url" => "ventas", "type" => 0 );
	$projectEntitiesReverse[ "ventas" ] = "ventas";
}
