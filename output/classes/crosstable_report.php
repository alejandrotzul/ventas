...
class CrossTableReport
{
	...
	{					
		...
		return "Grupo en el eje X"
			.":<b>".$this->xml_array["totals"][ $fieldNameX ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Grupo en el eje Y"
			.":<b>".$this->xml_array["totals"][ $fieldNameY ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Campo"
			.":<b>".$this->xml_array["totals"][ $fieldName ]["label"]."</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Función para agrupar"
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("cliente" == $this->xml_array['tables'][0])
			$isDB = true;
		if("detallefactura" == $this->xml_array['tables'][0])
			$isDB = true;
		if("facturas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("producto" == $this->xml_array['tables'][0])
			$isDB = true;
		if("producto_has_ventas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("ventas" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
	}
