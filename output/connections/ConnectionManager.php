...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connectionString"] = "mysql;localhost;root;;;mydb;;1"; //currently unused
		...
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=mydb;OPTION=3";
		// encription set
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["cliente"] = "mydb_at_localhost";
		$connectionsIds["detallefactura"] = "mydb_at_localhost";
		$connectionsIds["facturas"] = "mydb_at_localhost";
		$connectionsIds["producto"] = "mydb_at_localhost";
		$connectionsIds["producto_has_ventas"] = "mydb_at_localhost";
		$connectionsIds["ventas"] = "mydb_at_localhost";
