...
$page_layouts["producto_has_ventas_edit"] = $layout;
...
$page_layouts["producto_has_ventas_list"] = $layout;
...
$keys = array();
$keys["producto_idproducto"] = postvalue("editid1");
$keys["ventas_idventas"] = postvalue("editid2");
